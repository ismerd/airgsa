    ...
    <main className="grid min-h-screen place-items-center bg-page px-5">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <h1 className="mt-2 text-2xl font-bold text-ink">Choose a new password</h1>
          <p className="mt-2 text-sm text-ink-muted">Use the link from your email to finish the password reset.</p>
        </div>
