    ...
    <main className="min-h-screen bg-page px-5 py-8">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="py-10">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-brand">Cargo intelligence</p>
          <h1 className="mt-4 text-4xl font-semibold text-ink">News feed</h1>
