...
const huntAlerts: HuntAlert[] = [
  {
    ...
    totalKg: 108000,
    urgency: "urgent",
    message: "JED–FRA B747-8F has significant capacity remaining. All product types accepted. Push pharma, express, and general cargo to your forwarder contacts immediately.",
    daysToDepart: 2,
    receivedAt: "09:14",
  },
  {
    ...
    totalKg: 108000,
    urgency: "critical",
    message: "JED–HKG has critical low load. Priority: high-value, pharma, e-commerce. Rate flexibility available for volume bookings above 1,000 kg.",
    daysToDepart: 2,
    receivedAt: "11:30",
  },
];
