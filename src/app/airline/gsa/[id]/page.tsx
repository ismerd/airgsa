      ...
      <main className="grid gap-5 p-5 xl:grid-cols-[1fr_.65fr]">
        <Card>
          ...
          <CardContent className="space-y-5">
            <p className="text-lg leading-8 text-slate-200">{gsa.summary}</p>
            ...
            <div>
              <p className="mb-2 text-sm font-semibold text-white">Coverage</p>
              <div className="flex flex-wrap gap-2">
                {gsa.coverage.map((item) => <Badge key={item}>{item}</Badge>)}
              </div>
            </div>
            <div>
              <p className="mb-2 text-sm font-semibold text-white">Certifications</p>
              <div className="flex flex-wrap gap-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="rounded-md bg-slate-950/60 p-4 text-sm leading-6 text-slate-300">
