    ...
    <Card className="overflow-hidden">
      ...
      <CardContent>
        <div className="relative h-72 overflow-hidden rounded-md border border-cyan-300/20 bg-[#0A1F44]">
          ...
          <div className="absolute inset-x-6 bottom-6 flex items-center justify-between rounded-md border border-white/10 bg-slate-950/70 p-4">
            <div>
              <p className="text-sm font-semibold text-white">Placeholder map layer</p>
              <p className="text-xs text-slate-400">Ready for Mapbox token, lane overlays, and station coverage.</p>
            </div>
