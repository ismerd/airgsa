...
export const cargoProductOptions: CargoProductOption[] = [
  ...
  product("Express cargo", "Priority parcel and premium cargo flows", ["express", "priority", "parcel express", "premium cargo"]),
  product("Time-critical / urgent", "Emergency shipments, hand-carry, NFO, and line-stopper freight", [
    "urgent",
    "time critical",
    "time-critical",
    "emergency",
